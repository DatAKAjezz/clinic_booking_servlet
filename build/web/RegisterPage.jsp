    ...
    <div class="register-container">
        ...
        <div class="section color-text">
            ...
            <form action="MainServlet" method="post">
                ...
                <div class="input-group">
                    <label class="heading-input"><span class="required">*</span> Sex</label>
                    <div class="gender-group">
                        <label class="radio-label"><span>Male</span><input type="radio" name="sex" value="Male" required></label>
                        <label class="radio-label"><span>Female</span><input type="radio" name="sex" value="Female" required></label>
                    </div>
                </div>
                <div class="input-group">
