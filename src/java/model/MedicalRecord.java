...
public class MedicalRecord {
    ...
    private int appointmentId; // appointment_id
    private Date visitDate;    // visit_date
    private String diagnosis;  // diagnosis (NVARCHAR)
    private String prescription; // prescription (NVARCHAR)
    private String notes;      // notes (NVARCHAR)
