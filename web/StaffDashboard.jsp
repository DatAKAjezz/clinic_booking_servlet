                ...
                <div class="appointment-card">
                    ...
                    <div class="patient-info">
                        ...
                        <form action="StaffDashboardServlet" method="POST" style="display: inline;">
                            ...
                            <button type="submit" class="delete-btn" onclick="return confirm('Bạn có chắc muốn xóa lịch hẹn này? Lịch hẹn sẽ không hiển thị nữa nhưng vẫn được lưu trong hệ thống.');"><i class="bi bi-trash"></i> Xóa</button>
                        </form>
                    </div>
                </c:forEach>
